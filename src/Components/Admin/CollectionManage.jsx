    ...
    <div className="space-y-6 font-outfit">
      ...
      {collections.length === 0 && (
        <div className="text-center py-20" style={{
          ...
          <p className="text-gray-300 text-xs mt-1">Click "Add Collection" to create your first collection</p>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {collections.map((item) => (
          ...
          >
            {/* Image 3:4 */}
            <div className="aspect-[3/4] overflow-hidden" style={{ background: '#f8f9fa' }}>
              <img 
                src={item.image} 
                alt={item.name} 

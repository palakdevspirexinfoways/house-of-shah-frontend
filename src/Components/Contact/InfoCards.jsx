  ...
  const cards = [
    {
      ...
      type: "contact",
      details: [
        { text: "+91 95108 06869", link: "tel:+919510806869" },
        { text: "houseofshahexports@gmail.com", link: "mailto:houseofshahexports@gmail.com" }
      ]
    },
    {
      ...
      title: "Visit Us",
      type: "map",
      mapLink: "https://maps.app.goo.gl/jcryDF3kYoxPe5sq9",
          ...
          {cards.map((card, index) => {
            const cardContent = (
              <>
                ...
                <div className="space-y-1.5 text-gray-500 group-hover:text-white/90 transition-colors duration-500">
                  {card.type === "contact" ? (
                    card.details.map((detail, idx) => (
                      <p key={idx} className="text-sm" style={{ lineHeight: '1.2' }}>
                        <a 
                          href={detail.link} 
            ...
            if (card.type === "map") {
              return (
                <motion.a 
                  ...
                  className="bg-white border border-gray-100 p-10 flex flex-col items-center text-center group hover:bg-[var(--primary-blue)] hover:border-[var(--primary-blue)] hover:-translate-y-2 transition-all duration-500 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.15)] cursor-pointer"
                >
                  {cardContent}
                </motion.a>
              );
